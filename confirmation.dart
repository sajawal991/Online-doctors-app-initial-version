...
class _ConfirmationPageState extends State<ConfirmationPage> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(height: 10),
            Text(
                "Service".tr+": ${args.serviceName == "Online" ? "Video Consultation" : "Clinic  Visit"}",
                style: kCardSubTitleStyle),
            SizedBox(height: 10),
            ...
            SizedBox(height: 10),
            newAmount==null?
            Text("Pay Amount: ₹ $_amount",      style: TextStyle(
                fontSize: 16,
                fontFamily: "OpenSans-SemiBold"
            )) : Text("Pay Amount: ₹ $newAmount",      style: TextStyle(
                fontSize: 16,
                fontFamily: "OpenSans-SemiBold"
            )),
            SizedBox(height: 10),
            Text("Available Wallet Balance ₹ ${_patientDetailsArgs!.pPhn} $walletBalance",
              style: TextStyle(
                  fontSize: 16,
                  fontFamily: "OpenSans-SemiBold"
              ),),
  ...
  void _updateBookedPayLaterSlot(
    ...
    if (insertStatus != "error") {
      ...
      ToastMsg.showToastMsg("Something went wrong. try again 2 ${insertStatus}".tr);
      Navigator.pop(context);
    }
