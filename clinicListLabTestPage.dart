import 'package:demopatient/Screen/labTest/labTestListPage.dart';
...
class ClinicListLabTestPage extends StatefulWidget {
  final cityId;
  final cityName;
  ClinicListLabTestPage({this.cityId, this.cityName});
  @override
  _ClinicListLabTestPageState createState() => _ClinicListLabTestPageState();
}

class _ClinicListLabTestPageState extends State<ClinicListLabTestPage> {
  @override
          ...
          children: <Widget>[
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: FutureBuilder(
                    future: ClinicService.getData(widget.cityId), //fetch images form database
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => LabTestListPage(
              clinicId: listDetails.id,
              clinicName: listDetails.title,
              locationName:listDetails.locationName,
            ),
          ),
        );
      },
